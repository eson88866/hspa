...
class RouteRecord():
    def __init__(self):
        ...
        self.scores = {
            ...
            'score_composed': 0,
            # adas_test ###
            '0.turn_left_collision':0,
            '1.turn_right_collision':0,
            '2.front_collision':0,
            '3.lanechange_collision':0,
            '4.junction_collision':0,
            '5.avg_dev':0,
            '6.sec_dev>1m':0,
            '7.sec_brake>0.5':0,
            '8.sec_throt>0.5':0,
                ...
                if node.list_traffic_events:
                    ...
                    for event in node.list_traffic_events:
                        if event.get_type() == TrafficEventType.COLLISION_STATIC:
                            ...
                            ###
                            route_record.scores['0.turn_left_collision'] =event.get_dict()['turn_left_collision']
                            route_record.scores['1.turn_right_collision'] =event.get_dict()['turn_right_collision']
                            route_record.scores['2.front_collision'] =event.get_dict()['front_collision']
                            route_record.scores['3.lanechange_collision'] =event.get_dict()['lanechange_collision']
                            route_record.scores['4.junction_collision'] =event.get_dict()['junction_collision']
                            ###
                        ...
                        # adas_test ###
                        elif event.get_type() == TrafficEventType.ADAS_TEST:###
                            route_record.scores['5.avg_dev'] =event.get_dict()['avg_dev']
                            route_record.scores['6.sec_dev>1m'] =event.get_dict()['sec_dev>1m']
                            route_record.scores['7.sec_brake>0.5'] =event.get_dict()['sec_brake>0.5']
                            route_record.scores['8.sec_throt>0.5'] =event.get_dict()['sec_throt>0.5']
                            route_record.scores['9.sec_steer>0.5'] =event.get_dict()['sec_steer>0.5']
                            route_record.scores['max_speed'] =event.get_dict()['max_speed']
                            route_record.scores['avg_speed'] =event.get_dict()['avg_speed']
    ...
    def compute_global_statistics(self, total_routes):
        ...
        if self._registry_route_records:
            for route_record in self._registry_route_records:
                ...
                # adas_test ###
                global_record.scores['0.turn_left_collision'] += route_record.scores['0.turn_left_collision']
                global_record.scores['1.turn_right_collision'] += route_record.scores['1.turn_right_collision']
                global_record.scores['2.front_collision'] += route_record.scores['2.front_collision']
                global_record.scores['3.lanechange_collision'] += route_record.scores['3.lanechange_collision']
                global_record.scores['4.junction_collision'] += route_record.scores['4.junction_collision']
                global_record.scores['5.avg_dev'] += route_record.scores['5.avg_dev']
                global_record.scores['6.sec_dev>1m'] += route_record.scores['6.sec_dev>1m']
                global_record.scores['7.sec_brake>0.5'] += route_record.scores['7.sec_brake>0.5']
                global_record.scores['8.sec_throt>0.5'] += route_record.scores['8.sec_throt>0.5']
                global_record.scores['9.sec_steer>0.5'] += route_record.scores['9.sec_steer>0.5']
                global_record.scores['avg_speed'] += route_record.scores['avg_speed']
                if global_record.scores['max_speed'] < route_record.scores['max_speed']:
                    global_record.scores['max_speed'] = route_record.scores['max_speed']
        ...
        # adas_test ###
        global_record.scores['0.turn_left_collision'] /= float(total_routes)
        global_record.scores['1.turn_right_collision'] /= float(total_routes)
        global_record.scores['2.front_collision'] /= float(total_routes)
        global_record.scores['3.lanechange_collision'] /= float(total_routes)
        global_record.scores['4.junction_collision'] /= float(total_routes)
        global_record.scores['5.avg_dev'] /= float(total_routes)
        global_record.scores['6.sec_dev>1m'] /= (float(total_routes))
        global_record.scores['7.sec_brake>0.5'] /= (float(total_routes))#1 sec = 20 step =2 Hz
        global_record.scores['8.sec_throt>0.5'] /= (float(total_routes))
        global_record.scores['9.sec_steer>0.5'] /= (float(total_routes))
        # global_record.scores['max_speed'] /= (float(total_routes))
        global_record.scores['avg_speed'] /= (float(total_routes))
