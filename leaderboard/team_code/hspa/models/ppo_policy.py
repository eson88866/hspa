...
from hspa.utils.config_utils import load_entry_point
...
class PpoPolicy(nn.Module):
    ...
    def __init__(self,
        ...
        features_extractor_entry_point = features_extractor_entry_point.replace("agents.rl_birdview","hspa")
        ...
        distribution_entry_point = distribution_entry_point.replace("agents.rl_birdview","hspa")
