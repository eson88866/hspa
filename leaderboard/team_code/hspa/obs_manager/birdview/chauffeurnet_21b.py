...
from hspa.utils.traffic_light import TrafficLightHandler
...
class ObsManager():
    def __init__(self, obs_configs,criteria_stop=None):
        ...
        self._masks_channels = 21#3 + 3*len(self._history_idx)
    ...
    def _define_obs_space(self):
        # print("###self._masks_channels:",self._masks_channels)
